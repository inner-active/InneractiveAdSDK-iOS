...
class ConsoleViewController: UIViewController {
    ...
    private func updateConsoleHeight(heightMultiplier: CGFloat) {
        ...
        consoleHeightConstraint = NSLayoutConstraint(item: console as Any, attribute: .height, relatedBy: .equal, toItem: view, attribute: .height, multiplier: heightMultiplier, constant: 0)
