...
- (UIBarButtonItem *)autoFillBarButtonItem {
    if (nil == _autoFillBarButtonItem) {
        _autoFillBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"AutoFill", @"AutoFill") style:UIBarButtonItemStylePlain target:self action:@selector(autoFill:)];
    }
