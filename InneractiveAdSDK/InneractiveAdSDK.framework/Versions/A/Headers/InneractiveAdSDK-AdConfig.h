...
typedef NS_ENUM(NSInteger, InneractiveVideoFullscreenOrientationMode) {
    /**
     *  @brief This is default mode.
     *
     * A video will be presented in a landscape mode. Can be rotated to any supported landscape orientation.
     */
    InneractiveVideoFullscreenOrientationModeForceLandscape = 0,
    /**
     *  @brief A video will be presented in portrait.
     */
    InneractiveVideoFullscreenOrientationModeForcePortrait = 1,
    /**
     ...
     */
    InneractiveVideoFullscreenOrientationModeMaskAll = 2
};
 ...
 *  @brief Video Layout.
 */
@property (nonatomic, strong, readonly) IaVideoLayout *videoLayout;
 ...
 */
@property (nonatomic, strong, readonly) IaNativeAdAssetDescription *nativeAdAssetsDescription;
