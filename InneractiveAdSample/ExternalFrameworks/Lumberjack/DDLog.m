...
+ (BOOL)isRegisteredClass:(Class)class
{
    ...
    NSString *className = [NSString stringWithFormat:@"%s",class_getName(class)];
    if ([className hasPrefix:@"IA"]) {
...
+ (NSArray *)registeredClasses
{
    ...
    for (i = 0; i < numClasses; i++)
    {
        ...
        if ([className isEqualToString:@"UIAccessibilitySafeCategory__NSObject"])
        {
